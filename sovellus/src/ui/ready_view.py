...
class ReadyView:
    ...
    def _initialize(self):
        ...
        info_label.grid(row=1, column=2, rowspan=1, columnspan=3, pady=45)
        start_sudden_death_button.grid(row=4, column=2, columnspan=1, pady=40)
        start_rounds_button.grid(row=4, column=4, columnspan=1, pady=40)
        return_button.grid(row=5, column=3, pady=40)
