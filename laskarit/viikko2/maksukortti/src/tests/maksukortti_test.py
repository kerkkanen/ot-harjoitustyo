...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_ei_vie_saldoa_negatiiviseksi(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        self.kortti_syo_maukkaasti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 8 euroa")

    def test_negatiivisen_summa_lataaminen_ei_muuta_kortin_saldoa(self):
        self.kortti.lataa_kortti(-10)
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10 euroa")

    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_tasarahalla(self):
        self.kortti.syo_edullisesti()
        self.kortt.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
